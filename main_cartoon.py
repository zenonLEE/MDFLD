...
def add_base_options(parser):
    ...
    group.add_argument('--data_definition', type=str, default='cartoon_dataset_400_v2', help="COFW, 300W, WFLW")
...
def add_train_options(parser):
    ...
    group.add_argument('--loss_func', type=str, default='STARLoss_v2', help="loss function") # STARLoss_v2, WingLoss, AWingLoss, smoothl1
    group.add_argument("--val_batch_size", type=int, default=2, help="the batch size in val process")
    group.add_argument("--val_num_workers", type=int, default=None, help="the num of workers in val process")


def add_eval_options(parser):
    group = parser.add_argument_group("eval")
    group.add_argument("--pretrained_weight", type=str, default='./pretrained_model/300W_STARLoss_NME_2_87.pkl',
...
def add_starloss_options(parser):
    ...
    group.add_argument('--star_dist', type=str, default='smoothl1', help='STARLoss distance function') # wing, smoothl1, l1, l2
